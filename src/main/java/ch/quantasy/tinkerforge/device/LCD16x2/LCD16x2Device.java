...
import ch.quantasy.gateway.message.LCD16x2.DeviceWriteLine;
import ch.quantasy.gateway.message.LCD16x2.LCD16x2Intent;
...
public class LCD16x2Device extends GenericDevice<BrickletLCD16x2, LCD16x2DeviceCallback, LCD16x2Intent> {
    ...
    @Override
    protected void addDeviceListeners(BrickletLCD16x2 device) {
    ...
    @Override
    protected void removeDeviceListeners(BrickletLCD16x2 device) {
