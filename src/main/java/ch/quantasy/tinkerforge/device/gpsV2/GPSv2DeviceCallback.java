 ...
 * @author reto
 */
public interface GPSv2DeviceCallback extends DeviceCallback, BrickletGPSV2.AltitudeListener, BrickletGPSV2.CoordinatesListener, BrickletGPSV2.DateTimeListener, BrickletGPSV2.MotionListener, BrickletGPSV2.PulsePerSecondListener, BrickletGPSV2.StatusListener {
    ...
    public void fixLEDConfigChanged(FixLEDConfig fixLEDConfigFor);
