 ...
 * @author reto
 */
public class XMasTreeLEDLightAgent01 {
    ...
    public XMasTreeLEDLightAgent01(URI mqttURI) throws MqttException {
        ...
        try {
            ...
            Logger.getLogger(XMasTreeLEDLightAgent01.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String[] args) throws Throwable {
        ...
        XMasTreeLEDLightAgent01 agent = new XMasTreeLEDLightAgent01(mqttURI);
        System.in.read();
    }
}
