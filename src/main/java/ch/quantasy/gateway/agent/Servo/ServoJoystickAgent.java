 ...
 * @author reto
 */
public class ServoJoystickAgent {
    ...
    public ServoJoystickAgent(URI mqttURI) throws MqttException, InterruptedException {
        ...
        gatewayClient = new GatewayClient(mqttURI, "epnerp4", new ClientContract("Agent", "ServoJoystick", "SJ01"));
        ...
        gatewayClient.publishIntent(joystickServiceContract.INTENT_CALIBRATE, true);

        gatewayClient.subscribe(joystickServiceContract.EVENT_POSITION, (topic, payload) -> {
            GCEvent<JoystickService.Position>[] position = gatewayClient.toEventArray(payload, JoystickService.Position.class);
        ...
        gatewayClient.publishIntent(joystickServiceContract.INTENT_POSITION_CALLBACK_PERIOD, 10);
