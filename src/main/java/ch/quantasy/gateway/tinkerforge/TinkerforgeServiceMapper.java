...
import ch.quantasy.gateway.service.tinkerforge.IMU.IMUService;
import ch.quantasy.gateway.service.tinkerforge.IMUV2.IMUV2Service;
import ch.quantasy.gateway.service.tinkerforge.LCD16x2.LCD16x2Service;
import ch.quantasy.gateway.service.tinkerforge.LCD20x4.LCD20x4Service;
import ch.quantasy.gateway.service.tinkerforge.RGBLEDButton.RGBLEDButtonService;
import ch.quantasy.gateway.service.tinkerforge.accelerometer.AccelerometerService;
import ch.quantasy.gateway.service.tinkerforge.ambientLight.AmbientLightService;
import ch.quantasy.gateway.service.tinkerforge.ambientLightV2.AmbientLightV2Service;
import ch.quantasy.gateway.service.tinkerforge.analogInV2.AnalogInV2Service;
import ch.quantasy.gateway.service.tinkerforge.analogOutV2.AnalogOutV2Service;
import ch.quantasy.gateway.service.tinkerforge.barometer.BarometerService;
import ch.quantasy.gateway.service.tinkerforge.co2.CO2Service;
import ch.quantasy.gateway.service.tinkerforge.color.ColorService;
import ch.quantasy.gateway.service.tinkerforge.dc.DCService;
import ch.quantasy.gateway.service.tinkerforge.distanceIR.DistanceIRService;
import ch.quantasy.gateway.service.tinkerforge.distanceUS.DistanceUSService;
import ch.quantasy.gateway.service.tinkerforge.dualButton.DualButtonService;
import ch.quantasy.gateway.service.tinkerforge.dualRelay.DualRelayService;
import ch.quantasy.gateway.service.tinkerforge.dustDetector.DustDetectorService;
import ch.quantasy.gateway.service.tinkerforge.gpsv2.GPSv2Service;
import ch.quantasy.gateway.service.tinkerforge.hallEffect.HallEffectService;
import ch.quantasy.gateway.service.tinkerforge.humidity.HumidityService;
import ch.quantasy.gateway.service.tinkerforge.joystick.JoystickService;
import ch.quantasy.gateway.service.tinkerforge.laserRangeFinder.LaserRangeFinderService;
import ch.quantasy.gateway.service.tinkerforge.ledStrip.LEDStripService;
import ch.quantasy.gateway.service.tinkerforge.line.LineService;
import ch.quantasy.gateway.service.tinkerforge.linearPoti.LinearPotiService;
import ch.quantasy.gateway.service.tinkerforge.loadCell.LoadCellService;
...
import ch.quantasy.gateway.service.tinkerforge.servo.ServoService;
import ch.quantasy.gateway.service.tinkerforge.solidStateRelay.SolidStateRelayService;
import ch.quantasy.gateway.service.tinkerforge.soundIntensity.SoundIntensityService;
import ch.quantasy.gateway.service.tinkerforge.temperature.TemperatureService;
import ch.quantasy.gateway.service.tinkerforge.temperatureIR.TemperatureIRService;
import ch.quantasy.gateway.service.tinkerforge.thermalImaging.ThermalImagingService;
import ch.quantasy.gateway.service.tinkerforge.thermoCouple.ThermoCoupleService;
import ch.quantasy.gateway.service.tinkerforge.tilt.TiltService;
import ch.quantasy.gateway.service.tinkerforge.uvLight.UVLightService;
import ch.quantasy.gateway.service.tinkerforge.voltageCurrent.VoltageCurrentService;
