 ...
 *  *
 */
package ch.quantasy.gateway.intent.ptc;
...
public class DeviceResistanceCallbackThreshold {
    ...
    public DeviceResistanceCallbackThreshold(char option, int min, int max) {
        this.option = option;
        this.min = min;
        this.max = max;
    }

    public DeviceResistanceCallbackThreshold(BrickletPTC.ResistanceCallbackThreshold threshold) {
