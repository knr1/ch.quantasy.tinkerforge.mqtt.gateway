 ...
 * @author reto
 */
public class PulseWidth extends AValidator {
    ...
    public PulseWidth(Integer min, Integer max) {
        this.min = min;
        this.max = max;
    }

    public PulseWidth(BrickServo.PulseWidth pulseWidth) {
        this(pulseWidth.min, pulseWidth.max);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final PulseWidth other = (PulseWidth) obj;
