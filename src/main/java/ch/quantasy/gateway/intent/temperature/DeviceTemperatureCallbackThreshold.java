...
public class DeviceTemperatureCallbackThreshold extends AValidator {
    ...
    public DeviceTemperatureCallbackThreshold(char option, short min, short max) {
        this.option = option;
        this.min = min;
        this.max = max;
    }

    public DeviceTemperatureCallbackThreshold(BrickletTemperature.TemperatureCallbackThreshold threshold) {
