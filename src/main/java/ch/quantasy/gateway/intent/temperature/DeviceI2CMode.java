 ...
 *  *
 */
package ch.quantasy.gateway.intent.temperature;
...
public class DeviceI2CMode extends AValidator {
    ...
    private DeviceI2CMode() {
    }

    public DeviceI2CMode(String mode) {
        this(Mode.valueOf(mode));
    }

    public DeviceI2CMode(Mode mode) {
        this.mode = mode;
    }

    public DeviceI2CMode(short mode) throws IllegalArgumentException {
        this(Mode.getModeFor(mode));
    }
