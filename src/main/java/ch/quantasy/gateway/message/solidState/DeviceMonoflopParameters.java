...
public class DeviceMonoflopParameters extends AValidator {
    ...
    public DeviceMonoflopParameters(boolean state, long period) {
        this.state = state;
        this.period = period;
    }

    public DeviceMonoflopParameters(BrickletSolidStateRelay.Monoflop monoflop) {
        this(monoflop.state, monoflop.time);
    }
