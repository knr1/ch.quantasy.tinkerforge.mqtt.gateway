...
public class DeviceWriteLine extends AValidator {
    ...
    public DeviceWriteLine(String text, short line, short position) {
        this.text = text;
        this.line = line;
    ...
    public int hashCode() {
        int hash = 5;
        hash = 43 * hash + this.line;
        hash = 43 * hash + this.position;
        hash = 43 * hash + this.text.length();
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DeviceWriteLine other = (DeviceWriteLine) obj;
