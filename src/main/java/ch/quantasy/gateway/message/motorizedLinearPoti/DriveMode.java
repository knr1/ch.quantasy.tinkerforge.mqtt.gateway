 ...
 * @author reto
 */
public enum DriveMode implements Validator {
    FAST(BrickletMotorizedLinearPoti.DRIVE_MODE_FAST), SMOOTH(BrickletMotorizedLinearPoti.DRIVE_MODE_SMOOTH);
    private int value;
