 ...
 *
 */
package ch.quantasy.gateway.message.event.stackManager;
...
public class StackAddressEvent extends AnEvent{
    ...
    private StackAddressEvent() {
    }

    public StackAddressEvent(boolean state, TinkerforgeStackAddress stackAddress) {
        this.state= state;
