 ...
 *
 */
package ch.quantasy.gateway.message.event.accelerometer;
 ...
 * @author reto
 */
public class AccelerometerEvent extends AnEvent{
    ...
    public AccelerometerEvent(short x, short y, short z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
