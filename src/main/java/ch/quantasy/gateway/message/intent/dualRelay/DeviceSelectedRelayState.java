 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.dualRelay;
...
public class DeviceSelectedRelayState extends AValidator {
    ...
    public DeviceSelectedRelayState(short relay, boolean state) {
        this.relay = relay;
        this.state = state;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DeviceSelectedRelayState other = (DeviceSelectedRelayState) obj;
