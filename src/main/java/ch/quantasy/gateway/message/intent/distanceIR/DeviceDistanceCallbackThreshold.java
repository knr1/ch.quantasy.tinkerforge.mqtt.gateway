 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.distanceIR;
...
public class DeviceDistanceCallbackThreshold extends AValidator {
    ...
    public DeviceDistanceCallbackThreshold(char option, int min, int max) {
        this.option = option;
        this.min = min;
        this.max = max;
    }

    public DeviceDistanceCallbackThreshold(BrickletDistanceIR.DistanceCallbackThreshold threshold) {
