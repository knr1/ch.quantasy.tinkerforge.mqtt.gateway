 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.segment4x7;
...
public class DeviceSegments extends AValidator {
    ...
    public DeviceSegments() {
    }

    public DeviceSegments(BrickletSegmentDisplay4x7.Segments segments) {
        this(segments.segments, segments.brightness, segments.colon);
    }
