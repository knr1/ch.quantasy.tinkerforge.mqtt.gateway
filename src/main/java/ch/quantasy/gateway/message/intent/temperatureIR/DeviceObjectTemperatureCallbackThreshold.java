 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.temperatureIR;
 ...
 * @author reto
 */
public class DeviceObjectTemperatureCallbackThreshold extends AValidator {

    @Choice(values = {"x", "o", "i", "<", ">"})
    private char option;
    @Range(from = -700, to = 3800)
    private short min;
    @Range(from = -700, to = 3800)
    private short max;

    private DeviceObjectTemperatureCallbackThreshold() {
    }
