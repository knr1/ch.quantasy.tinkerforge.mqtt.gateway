 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.rotaryPoti;
...
public class DevicePositionCallbackThreshold extends AValidator {
    ...
    public DevicePositionCallbackThreshold(char option, short min, short max) {
        this.option = option;
        this.min = min;
        this.max = max;
    }

    public DevicePositionCallbackThreshold(BrickletRotaryPoti.PositionCallbackThreshold threshold) {
