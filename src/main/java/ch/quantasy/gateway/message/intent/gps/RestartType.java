 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.gps;
...
public enum RestartType implements Validator {
    ...
    private RestartType(short value) {
        this.value = value;
    }
    ...
    public static RestartType getRestartTypeFor(short s) throws IllegalArgumentException {
        for (RestartType range : values()) {
            if (range.value == s) {
                return range;
            }
        }
