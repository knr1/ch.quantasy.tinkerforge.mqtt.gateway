 ...
 *  *
 */
package ch.quantasy.gateway.message.intent.linearPoti;
...
public class DevicePositionCallbackThreshold extends AValidator {
    ...
    public DevicePositionCallbackThreshold(char option, int min, int max) {
        this.option = option;
        this.min = min;
        this.max = max;
    }

    public DevicePositionCallbackThreshold(BrickletLinearPoti.PositionCallbackThreshold threshold) {
