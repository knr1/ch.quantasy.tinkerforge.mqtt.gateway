...
import ch.quantasy.gateway.message.dc.*;
 ...
 * @author reto
 */
public class StepperIntent extends AnIntent {
    ...
    public Integer motorCurrent;
    @Nullable
    public DeviceSpeedRamp speedRamp;
    @Nullable
