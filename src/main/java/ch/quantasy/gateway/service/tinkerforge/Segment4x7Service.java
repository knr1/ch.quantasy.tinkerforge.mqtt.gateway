...
import ch.quantasy.gateway.binding.tinkerforge.segment4x7.CounterEvent;
...
import ch.quantasy.gateway.binding.tinkerforge.segment4x7.SegmentsStatus;
...
public class Segment4x7Service extends AbstractDeviceService<Segment4x7Device, Segment4x7ServiceContract> implements Segment4x7DeviceCallback {
    ...
    public void segmentsChanged(DeviceSegments segments) {
        readyToPublishStatus(getContract().STATUS_SEGMENTS, new SegmentsStatus(segments));
    }
