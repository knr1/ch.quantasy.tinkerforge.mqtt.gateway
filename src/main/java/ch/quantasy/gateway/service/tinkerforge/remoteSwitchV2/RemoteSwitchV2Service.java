 ...
 *  *
 */
package ch.quantasy.gateway.service.tinkerforge.remoteSwitchV2;
...
import ch.quantasy.gateway.message.remoteSwitchV2.RepeatsStatus;
import ch.quantasy.gateway.message.remoteSwitchV2.RemoteSwitchConfiguration;
import ch.quantasy.gateway.message.remoteSwitchV2.RemoteSwitchConfigurationStatus;
import ch.quantasy.gateway.message.remoteSwitchV2.SwitchAEvent;
import ch.quantasy.gateway.message.remoteSwitchV2.SwitchBEvent;
import ch.quantasy.gateway.message.remoteSwitchV2.SwitchCEvent;
