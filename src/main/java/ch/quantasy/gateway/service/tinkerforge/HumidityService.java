...
import ch.quantasy.gateway.binding.tinkerforge.humidity.HumidityServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.humidity.AnalogValueEvent;
import ch.quantasy.gateway.binding.tinkerforge.humidity.HumidityEvent;
...
import ch.quantasy.gateway.binding.tinkerforge.humidity.DeviceAnalogValueCallbackThreshold;
import ch.quantasy.gateway.binding.tinkerforge.humidity.DevicePositionCallbackThreshold;
import ch.quantasy.gateway.binding.tinkerforge.humidity.AnalogCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.humidity.AnalogValueCallbackThresholdStatus;
import ch.quantasy.gateway.binding.tinkerforge.humidity.DebouncePeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.humidity.HumidityCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.humidity.HumidityCallbackThresholdStatus;
