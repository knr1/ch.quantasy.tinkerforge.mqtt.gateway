...
import ch.quantasy.gateway.binding.tinkerforge.hallEffect.HallEffectServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.hallEffect.EdgeCountEvent;
import ch.quantasy.gateway.service.tinkerforge.AbstractDeviceService;
import ch.quantasy.gateway.binding.tinkerforge.hallEffect.DeviceConfiguration;
import ch.quantasy.gateway.binding.tinkerforge.hallEffect.EdgeCountCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.hallEffect.EdgeCountConfigurationStatus;
import ch.quantasy.gateway.binding.tinkerforge.hallEffect.EdgeCountInterruptStatus;
