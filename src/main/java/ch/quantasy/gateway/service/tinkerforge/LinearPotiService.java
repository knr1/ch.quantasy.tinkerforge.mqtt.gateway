...
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.LinearPotiServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.AnalogValueEvent;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.PositionEvent;
import ch.quantasy.gateway.service.tinkerforge.AbstractDeviceService;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.DeviceAnalogValueCallbackThreshold;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.DevicePositionCallbackThreshold;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.AnalogCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.AnalogValueCallbackThresholdStatus;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.DebouncePeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.PositionCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.linearPoti.PositionCallbackThresholdStatus;
