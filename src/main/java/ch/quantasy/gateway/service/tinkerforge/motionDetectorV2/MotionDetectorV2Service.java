 ...
 *  *
 */
package ch.quantasy.gateway.service.tinkerforge.motionDetectorV2;

import ch.quantasy.gateway.message.motionDetectorV2.Indicator;
import ch.quantasy.gateway.message.motionDetectorV2.IndicatorStatus;
import ch.quantasy.gateway.message.motionDetectorV2.MotionDetectionCycleEndedEvent;
import ch.quantasy.gateway.message.motionDetectorV2.MotionDetectionDetected;
import ch.quantasy.gateway.message.motionDetectorV2.SensitivityStatus;
