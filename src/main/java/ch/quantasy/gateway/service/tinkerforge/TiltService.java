...
import ch.quantasy.gateway.binding.tinkerforge.tilt.TiltServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.tilt.TiltEvent;
...
public class TiltService extends AbstractDeviceService<TiltDevice, TiltServiceContract> implements BrickletTilt.TiltStateListener {
    ...
    public void tiltState(short s) {
        readyToPublishEvent(getContract().EVENT_TILT_STATE, new TiltEvent(s));
    }
}
