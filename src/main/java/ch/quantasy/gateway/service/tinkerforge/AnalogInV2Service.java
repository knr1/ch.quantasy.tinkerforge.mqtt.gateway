...
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.AnalogInV2ServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.AnalogValueEvent;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.VoltageEvent;
...
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.DeviceAnalogValueCallbackThreshold;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.DeviceVoltageCallbackThreshold;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.AnalogValueCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.AnalogValueCallbackThresholdStatus;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.DebouncePeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.MovingAverageStatus;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.VoltageCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.analogInV2.VoltageCallbackThresholdStatus;
import java.net.URI;
...
public class AnalogInV2Service extends AbstractDeviceService<AnalogInV2Device, AnalogInV2ServiceContract> implements AnalogInV2DeviceCallback {
    ...
    public void voltageCallbackPeriodChanged(long period) {
        readyToPublishStatus(getContract().STATUS_VOLTAGE_CALLBACK_PERIOD, new VoltageCallbackPeriodStatus(period));
    }
    ...
    public void voltageCallbackThresholdChanged(DeviceVoltageCallbackThreshold threshold) {
        readyToPublishStatus(getContract().STATUS_VOLTAGE_THRESHOLD, new VoltageCallbackThresholdStatus(threshold));
    }
