...
public class DistanceUSServiceContract extends DeviceServiceContract {
    ...
    public DistanceUSServiceContract(DistanceUSDevice device) {
        ...
        DISTANCE = "distance";
        STATUS_TOPIC_ILLUMINANCE = STATUS_TOPIC + "/" + DISTANCE;
        STATUS_TOPIC_DISTANCE_THRESHOLD = STATUS_TOPIC_ILLUMINANCE + "/" + THRESHOLD;
        STATUS_TOPIC_DISTANCE_CALLBACK_PERIOD = STATUS_TOPIC_ILLUMINANCE + "/" + CALLBACK_PERIOD;
        EVENT_TOPIC_DISTANCE = EVENT_TOPIC + "/" + DISTANCE;
        EVENT_TOPIC_DISTANCE_REACHED = EVENT_TOPIC_DISTANCE + "/" + REACHED;
        INTENT_TOPIC_ILLUMINANCE = INTENT_TOPIC + "/" + DISTANCE;
