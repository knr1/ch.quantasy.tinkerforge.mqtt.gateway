...
public class DistanceIRServiceContract extends DeviceServiceContract {
    ...
    public DistanceIRServiceContract(DistanceIRDevice device) {
        ...
        STATUS_DISTANCE_THRESHOLD = STATUS_ILLUMINANCE + "/" + THRESHOLD;
        STATUS_ILLUMINANCE_CALLBACK_PERIOD = STATUS_ILLUMINANCE + "/" + CALLBACK_PERIOD;
        EVENT_DISTANCE = EVENT + "/" + ILLUMINANCE;
        EVENT_DISTANCE_REACHED = EVENT_DISTANCE + "/" + REACHED;
        INTENT_ILLUMINANCE = INTENT + "/" + ILLUMINANCE;
        INTENT_DISTANCE_THRESHOLD = INTENT_ILLUMINANCE + "/" + THRESHOLD;
        INTENT_DISTANCE_CALLBACK_PERIOD = INTENT_ILLUMINANCE + "/" + CALLBACK_PERIOD;
