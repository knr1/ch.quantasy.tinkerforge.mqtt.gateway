...
import ch.quantasy.tinkerforge.device.co2Device.CO2DeviceCallback;
import ch.quantasy.tinkerforge.device.co2Device.DeviceCO2ConcentrationCallbackThreshold;
...
public class CO2Service extends AbstractDeviceService<CO2Device, CO2ServiceContract> implements CO2DeviceCallback {
    ...
    class CO2ConcentrationEvent {
        ...
        protected long co2Concentration;
        ...
        public long getCo2Concentration() {
