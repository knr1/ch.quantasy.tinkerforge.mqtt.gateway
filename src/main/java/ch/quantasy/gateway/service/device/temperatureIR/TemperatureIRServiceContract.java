...
public class TemperatureIRServiceContract extends DeviceServiceContract {
    ...
    public TemperatureIRServiceContract(TemperatureIRDevice device) {
        ...
        STATUS_ILLUMINANCE = STATUS + "/" + OBJECT_TEMPERATURE;
        STATUS_OBJECT_TEMPERATURE_THRESHOLD = STATUS_ILLUMINANCE + "/" + THRESHOLD;
        ...
        INTENT_ILLUMINANCE = INTENT + "/" + OBJECT_TEMPERATURE;
        INTENT_OBJECT_TEMPERATURE_THRESHOLD = INTENT_ILLUMINANCE + "/" + THRESHOLD;
        INTENT_OBJECT_TEMPERATURE_CALLBACK_PERIOD = INTENT_ILLUMINANCE + "/" + CALLBACK_PERIOD;
