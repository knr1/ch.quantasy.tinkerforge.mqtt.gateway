 ...
 * @author reto
 */
public class StackManagerServiceContract extends TinkerForgeServiceContract {
    ...
    public StackManagerServiceContract(String id) {
        this(id, "Manager");
    }

    public StackManagerServiceContract(String id, String device) {
        super(device, id, TinkerforgeStackIntent.class);
