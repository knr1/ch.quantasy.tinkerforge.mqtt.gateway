...
import ch.quantasy.gateway.binding.tinkerforge.DeviceServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.AnalogValueEvent;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.DistanceEvent;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.DistanceIRIntent;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.AnalogCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.AnalogValueCallbackThresholdStatus;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.DebouncePeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.DistanceCallbackPeriodStatus;
import ch.quantasy.gateway.binding.tinkerforge.distanceIR.DistanceCallbackThresholdStatus;
...
public class DistanceIRServiceContract extends DeviceServiceContract {
    ...
    public DistanceIRServiceContract(String id, String device) {
        super(id, device, DistanceIRIntent.class);
