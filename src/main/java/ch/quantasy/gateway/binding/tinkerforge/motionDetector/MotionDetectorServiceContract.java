 ...
 *  *
 */
package ch.quantasy.gateway.binding.tinkerforge.motionDetector;

import ch.quantasy.gateway.binding.tinkerforge.DeviceServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.DeviceServiceContract;
import ch.quantasy.gateway.binding.tinkerforge.motionDetector.MotionDetectionCycleEndedEvent;
import ch.quantasy.gateway.binding.tinkerforge.motionDetector.MotionDetectionDetected;
