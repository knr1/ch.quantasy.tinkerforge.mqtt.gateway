...
public class TagIDEvent extends AnEvent {
    ...
    public TagIDEvent(NFCTag tag) {
        this(tag.getTidAsHexString(), tag.getType(), tag.getLatestDiscoveryTimeStamp());
    }

    public TagIDEvent(String id, NFCType type, long latestDiscoveryTimeStamp) {
        this.id = id;
        this.type = type;
